...
public class StikkyHeaderListView extends StikkyHeader {
    ...
    StikkyHeaderListView(final Context context, final ListView listView, final View header, final int minHeightHeader, final HeaderStikkyAnimator headerAnimator) {
